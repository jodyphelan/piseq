...
def trim(args):
    ...
    os.system("java -jar trimmomatic.jar PE -threads %s -phred33 %s %s %s_1_trimmed_paired.txt %s_1_trimmed_unpaired.txt %s_2_trimmed_paired.txt %s_2_trimmed_unpaired.txt LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:36" % (threads,fastq1File,fastq2File,sample,sample,sample,sample))
